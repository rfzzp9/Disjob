...
//    }
    ...
    @NonNull
    @Override
    public Adapter_scrap.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_scrap.CustomViewHolder customViewHolder, int i) {
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomViewHolder(@NonNull View itemView) {
            ...
            star.setTag(R.drawable.img_2); //repair 88
            star.setImageResource(R.drawable.img_2);
